...
import com.digital.apigateway.ProductContext;
...
public class ProductRoute {
	...
	public ResponseEntity<?> search(@PathVariable String keyword) {
		...
		try {
			...
			productRes = productContext.searchProduct(keyword);
		} catch (Exception e) {
	...
	public ResponseEntity<?> insert(
		...
		ErrorMsg errors = new ErrorMsg();
		try {
			// Product Insert Routing
			product = productContext.insertProduct(product);
